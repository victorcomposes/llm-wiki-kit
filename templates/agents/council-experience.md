...
3. Which option leaks an internal name or system into user-facing text? Check against `{{VAULT_DIR}}\wiki\concepts\ubiquitous-language.md` for the words the user actually uses.
