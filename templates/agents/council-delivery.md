...
4. Is there a simpler option being passed over for schedule reasons, and would it actually be faster? Check the ticket folder under `C:\Dev\.vault\tickets\<id>\` for stated deadlines and related tickets.
